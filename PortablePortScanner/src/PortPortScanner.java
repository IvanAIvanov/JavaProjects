...
public class PortPortScanner  extends Frame implements ActionListener, Runnable
{
    ...
    public PortPortScanner()
    {
        super("Portable Scanner v 1.0");
        setBackground(new Color(192, 192, 192));
        setLocation(200, 200);
        gbc = new GridBagConstraints();
        setLayout(new GridBagLayout());

        status = new Label("Portable Scanner - ready");
        version = new Label("Portable Scanner version 1.0", Label.CENTER);
        ...
        add(new Label("Host name:", Label.RIGHT), 0, 1);
        add(hostName, 1, 1);
